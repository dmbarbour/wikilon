 ...
 * boolean and optional parse data to diagnose common errors.
 *
 ...
 *
 * Note: This parser is intended for lightweight error detection
 * only. It isn't directly used by the runtime.
 */
